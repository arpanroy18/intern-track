                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-slate-800/50 border border-slate-700 rounded-lg text-gray-100 focus:outline-none focus:border-purple-400"
                    >
                    ...
                    <button
                      ...
                      className="w-full mt-2 py-2 px-4 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors font-medium"
                    >
                      Apply and Reload
                    </button>
                  </div>
